...
const AddCategoryContainer = (props) => {
    ...
    return (
        <div className={style.wrapper}>
            <AddCategory createCategoryCont={createCategoryCont} updatingNewCategoryCont={updatingNewCategoryCont} linkData={props.linkData} newLinkData={props.newLinkData}/>
        </div>
    );
}
